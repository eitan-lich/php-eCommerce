...
require_once ("C:/xampp/htdocs/www/php-website/controller/product.php");
                ...
                foreach($products as $product) {
                    ...
                    <div class='item-container'>
                        <form action='' method='post'>
                            ...
                            <h2>$$product->item_price</h2>
                            <h2>$product->item_manufacturer</h2>
                            <p>UPC - $product->item_upc</p>
                            <button type='button' class='see-more-btn'>See more</button>
                            <button class='add-cart-btn'>Add to cart</button>
                            <p class='item-description'>$product->item_description</p>
                            </form>
                        </div>";
                }
           // }
